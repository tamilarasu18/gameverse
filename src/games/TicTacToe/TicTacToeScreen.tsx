...
import { createBoard, checkWinner, isBoardFull, PLAYER_1, PLAYER_2 } from './logic';
...
export default function TicTacToeScreen({ route, navigation }: Props) {
  ...
  const handleCellClick = useCallback((index: number) => {
    if (currentState.winner || currentState.isDraw || !isMyTurn() || currentState.board[index] !== null) return;
